...
WebUI.click(findTestObject('Object Repository/Category/Delete_Category/svg_Computer_lucide w-4 h-4 mr-1'))

WebUI.click(findTestObject('Object Repository/Category/Delete_Category/button_Cancel'))
