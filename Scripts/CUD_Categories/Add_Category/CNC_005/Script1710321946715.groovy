...
WebUI.setText(findTestObject('Object Repository/Category/AddProduct/input__name'), 'Iphone')

WebUI.click(findTestObject('Object Repository/Category/AddProduct/button_Cancel'))
